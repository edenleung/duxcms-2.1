...
class UploadFile
{
    ...
    public function __construct($savePath = 'public/uploads/', $allowExts = ['gif', 'jpg', 'jpeg', 'bmp', 'png'], $maxSize = 10485760)
    {
        ...
        foreach ($files as $key =>$file) {
            ...
            if ($this->autoSave) {
                if (isset($this->saeStorage)) {
                    $file['savepath'] = str_replace(['../', './'], '', $file['savepath']);
    ...
    {
        if ($this->thumb && in_array($file['extension'], ['gif', 'jpg', 'jpeg', 'bmp', 'png'])) {
